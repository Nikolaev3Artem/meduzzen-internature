...
class QuizResultsNotFound(ObjectNotFound):
    def __init__(self, identifier_: str, model_name: str = "QuizResults") -> None:
        super().__init__(
            identifier_=f"for user id: {identifier_}", model_name=model_name
        )
